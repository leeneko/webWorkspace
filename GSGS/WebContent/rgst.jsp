		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav text-uppercase ml-auto">
					<li class="nav-item"><a class="nav-link js-scroll-trigger" href="#board">분양</a></li>
...
<%
	...
	ArrayList<RgstDTO> list = rdao.selectAll();
	request.setAttribute("list", list);
%>
	<!-- Services -->
	<section id="board">
			...
			<c:choose>
				...
				<c:otherwise>
					<div style="float: right;">
						<input type="button" class="btn btn-warning" value="글쓰기" onclick="location.href='rgstWrite.jsp'">
					</div>
				</c:otherwise>
			</c:choose>
		</div>
