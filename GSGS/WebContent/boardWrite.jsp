				...
				<ul class="navbar-nav text-uppercase ml-auto">
					...
					<c:choose>
						<c:when test="${sessionScope.memberdto == null }">
							<li class="nav-item"><a href="#loginlayer"
								class="btn-example nav-link">로그인</a></li>
						</c:when>
						<c:otherwise>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 text-left">
					<h4 class="section-heading text-uppercase">글쓰기</h4>
					<table class="table table-bordered">
						<tbody>
							<form action="upload.dog" method="post" enctype="multipart/form-data">
								<tr>
									<th>분류:</th>
									<td>
								...
								<tr>
									<th>제목:</th>
									<td><input type="text" name="board_title" placeholder="제목을 입력하세요" class="form-control" /></td>
								</tr>
								<tr>
									<th>내용:</th>
									<td><textarea cols="10" name="board_content" placeholder="내용을 입력하세요" class="form-control" maxlength="2000"></textarea></td>
								</tr>
								<tr>
									<th>첨부파일 (주의! 한글 파일명 금지)</th>
